...
class Sample
{
    static void Main()
    {
        ...
        int totalOuantity = product1.quantityInStock + product2.quantityInStock + product3.quantityInStock;

        Console.WriteLine("\nTotal Quantity : " +totalOuantity);
        Console.WriteLine("Total Number of Products: " + Product.totalNumberOfProducts);
